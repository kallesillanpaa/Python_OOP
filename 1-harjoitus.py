...
class Restaurant:
    def __init__(self, restaurant_name, cuisine_type): #dunder-metodi (lyhenne down-underscore) / magic-metodi
        self.restaurant_name = restaurant_name
        self.cuisine_type = cuisine_type

    def describe_restaurant(self):
        print("Restaurant name:" + self.restaurant_name + ",C..:" + self.cuisine_type)
